...
import { Member, EventCategory, Template } from '../../types';
       ...
       <div className="lg:col-span-4 space-y-6">
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
             ...
             <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Achievement Template</label>
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-3 py-2 rounded-md bg-mca-600 text-white text-sm font-semibold hover:bg-mca-700 disabled:opacity-50"
                    >
                      Apply
                    </button>
                  </div>
                ...
                {generatedContent && (
                  <div className="mt-4 p-3 bg-purple-50 rounded border border-purple-100">
                    <p className="text-xs text-purple-800 font-bold uppercase mb-1">Generated Message:</p>
